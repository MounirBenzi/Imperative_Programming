...
void insertAfter(list *xs, item x){
  ...
  //  printf("%d\n", newNode -> x);
    ...
    xs -> none -> next -> x = newNode -> x;
    //printf("%d\n", xs -> none -> next -> x );
    xs -> current -> back = newNode;
    xs -> none -> back -> next = xs -> none;
    //printf("%d\n", xs -> none -> back -> x );
    first(xs);
  }
  else{
    ...
    xs -> current -> next -> x = newNode -> x;
    xs -> current = xs -> current -> next;
    xs -> none -> back -> next = xs -> none;
  /*  printf("%d\n", xs -> current -> back -> x );
    printf("%d\n", xs -> current -> x );
    printf("%d\n", xs -> current -> back -> back -> back -> x );
    printf("hasdasdlka\n");*/
  }
}
